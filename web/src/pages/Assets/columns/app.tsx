...
export const getAppColumns = (navigate: (url: string) => void) => [
  ...
  { title: '下载链接', dataIndex: 'download_link', key: 'link', width: 180, ellipsis: true, render: (v: string) => v ? <a href={v} target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent-color)', fontSize: 12 }}>链接</a> : '-' },
